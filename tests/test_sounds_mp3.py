...
sound_file_path = "examples/game_sounds/fail.wav"
...
try:
    # Load the audio data
    data, sample_rate = sf.read(sound_file_path, dtype='float32')
    ...
    print(f"Error: The file '{sound_file_path}' was not found.")
