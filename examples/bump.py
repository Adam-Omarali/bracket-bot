...
def bump():
    ...
    controller.publish_velocity(desired_velocity, 0)
    ...
    try:
        while True:
            ...
            position, velocity, desired_velocity, angle = controller.get_state()
...
if __name__ == "__main__":
    p1 = Process(target=balance)
    p1.start()
    time.sleep(10)
    p2 = Process(target=bump)
    p2.start()
    # bump()
